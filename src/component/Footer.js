    ...
    return (
        <div className='container'>
            <div className=" d-flex" style={{ justifyContent: 'space-evenly', color: '#2f1c6a', margin: '15px 40px' }}>
                <div style={{ height: '410px', width: '200px' }}>
                    <h3>Hosting</h3>
                    <p>Web hosting</p>
                ...
                <div style={{  height: '349px', width: '200px' }}>
                    <h3>Domain</h3>
            ...
            <nav className=" navbar-expand-lg " style={{ fontSize: 'large', alignItems: 'center' }}>
                <div className="container-fluid d-flex">
                    <div>
                        <a className="navbar-brand" href="/" style={{color: '#2f1c6a'}}>Payment methods</a>
                    </div>
                    <div className=" navbar-collapse" style={{ justifyContent: 'flex-end' }} id="navbarSupportedContent">
                        <div className="d-flex" >
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
...
// {/* <div className="container-fluid d-flex"> */}
    // <div>
        // <a className="navbar-brand" href="/"><p style={{ fontSize: '15px', margin: '0px', color: '#2f1c6a' }}> © 2004-2024 hostinger.pk - Premium Web Hosting, Cloud, VPS, AI Website Builder & Domain Registration Services</p></a>
    // </div>
    // <div className=" navbar-collapse" style={{ justifyContent: 'flex-end' }} id="navbarSupportedContent">
        // <div className="d-flex" >
            // <ul className="navbar-nav me-auto mb-2 mb-lg-0">
