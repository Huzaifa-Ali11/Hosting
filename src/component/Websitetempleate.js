    ...
    return (
        <div>
            <div className='d-flex'>
                <div style={{ border: '2px solid black', width: '725px', height: '645px' }}>
                    <img src="technology.jpg" width={'722px'} height={'641px'} alt="img" />
                </div>
                <div style={{ border: '2px solid black', padding: '95px 129px', width: '603px', height: '645px', backgroundColor: 'black', color: 'white' }}>
                    <h1>Let AI do the hard work</h1>
                    <p style={{ margin: '25px -1px' }}>Choose the type of website you want and simply describe what you need. Let AI craft a unique website for you with relevant images and bespoke content. Use our powerful AI tools to fine-tune your website until you're ready to hit 'Go live'.</p>
                    <div>
                        <button type='button' style={{ height: '48px', width: '182px', margin: '90px 70spx', borderRadius: '15px' }}><b>Get Started</b></button>
                    </div>
                </div>
            </div>
            <div className="container" style={{ margin: '80px auto', textAlign: 'center', color: '#2f1c6a' }}>
            ...
            <div className='container' style={{ textAlign: 'center', color: '#2f1c6a' }}>
                ...
                <div className='d-flex' style={{ justifyContent: 'space-evenly', flexWrap: 'wrap' }}>
                    <div style={{ height: '230px', width: '330px', backgroundColor: '#f2f2f270', borderRadius: '15px' }}>
                    ...
                    <div style={{ height: '230px', width: '330px', marginTop: '30px', backgroundColor: '#f2f2f270', borderRadius: '15px' }}>
                ...
                <div style={{margin:'58px 0px'}}>
                    <button type='button' style={{ height: '48px', width: '182px', margin: '90px 70spx', backgroundColor:'black', color: 'white', borderRadius: '15px' }}><b>Get Started</b></button>
                </div>
            </div>
            <div className='d-flex'>
                <div style={{ border: '2px solid black', width: '725px', height: '645px' }}>
                    <img src="621d25cd92a9c1000165b198.jpg" width={'722px'} height={'641px'} alt="img" />
                </div>
                <div style={{ border: '2px solid black', padding: '95px 129px', width: '603px', height: '645px', backgroundColor: 'black', color: 'white' }}>
